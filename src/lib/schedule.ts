export const SEASON_2026 = [
  ...
  { startDate: "2026-05-29", track: "Road America", label: "Road America" },
  { startDate: "2026-06-26", track: "Ridge Motorsports Park", label: "Ridge Motorsports Park" },
  { startDate: "2026-07-10", track: "WeatherTech Raceway Laguna Seca", label: "WeatherTech Raceway Laguna Seca" },
  { startDate: "2026-07-31", track: "Mid-Ohio Sports Car Course", label: "Mid-Ohio Sports Car Course" },
  { startDate: "2026-08-14", track: "Virginia International Raceway", label: "Virginia International Raceway" },
